...
public class EntryLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return EntryLocalServiceUtil.addEntry((com.liferay.doc.guestbook.model.Entry)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return EntryLocalServiceUtil.deleteEntry((com.liferay.doc.guestbook.model.Entry)arguments[0]);
		}
		...
		if (_methodName19.equals(name) &&
			...
			return EntryLocalServiceUtil.updateEntry((com.liferay.doc.guestbook.model.Entry)arguments[0]);
		}
